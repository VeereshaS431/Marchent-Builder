...
export function HeroEditor({ data, onUpdate }) {
  ...
  const handleNestedStyleChange = (e, parent, child) => {
    ...
    onUpdate({
      ...
      styles: {
        ...data.styles,
        [parent]: { ...data.styles[parent], [child]: { ...data.styles[parent][child], [name]: value } },
      },
    });
  };
  ...
  const handleContentChange = (e) => {
    const { name, value } = e.target;
    onUpdate({ ...data, content: { ...data.content, [name]: value } });
  };
  ...
  const handleCtaChange = (e) => {
    ...
    onUpdate({ ...data, content: { ...data.content, cta: { ...data.content.cta, [name]: val } } });
  };
