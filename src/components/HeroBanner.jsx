...
const HeroBanner = ({ component, isSelected, handleComponentSelect, updateComponentContent }) => {
  const { id, content, style } = component;
  const { heading, subheading, buttonText, imageUrl } = content;
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div>
          <img src={imageUrl} alt="Hero" className="w-full h-auto rounded-lg" />
        </div>
      </div>
    </div>
  );
